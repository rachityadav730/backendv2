...
ActiveRecord::Schema.define(version: 2024_03_04_045411) do
  ...
  create_table "sys_config", primary_key: "variable", id: :string, limit: 128, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "value", limit: 128
    t.timestamp "set_time", default: -> { "CURRENT_TIMESTAMP" }
